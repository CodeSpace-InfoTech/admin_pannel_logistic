          ...
          <div className="grid grid-cols-3 gap-4">
            <div className="form-group">
              ...
              <input
                ...
                className={`w-full rounded-lg border p-2 border-black form-control ${errors.name ? 'border-danger' : ''}`}
              />
            ...
            <div className="form-group">
              ...
              <input
                ...
                onChange={handleChange}
                className={`w-full rounded-lg border p-2 border-black form-control ${errors.company ? 'border-danger' : ''}`}
              />
            ...
            <div className="form-group">
              ...
              <input
                ...
                onChange={handleChange}
                className={`w-full rounded-lg border p-2 border-black form-control ${errors.email ? 'border-danger' : ''}`}
              />
          ...
          <div className="grid grid-cols-3 gap-4">
            ...
            <div className="form-group">
              ...
              <input
                ...
                onChange={handleChange}
                className={`w-full rounded-lg border border-black form-control p-2 ${errors.street ? 'border-danger' : ''}`}
              />
              {errors.street && <span className="text-danger text-sm mt-1">{errors.street}</span>}
            </div>
            <div className="form-group">
              ...
              <input
                ...
                onChange={handleChange}
                className={`w-full rounded-lg border border-black form-control p-2 ${errors.city ? 'border-danger' : ''}`}
              />
              {errors.city && <span className="text-danger text-sm mt-1">{errors.city}</span>}
            </div>
          </div>
          ...
          <div className="grid grid-cols-3 gap-4">
            <div className="form-group">
              ...
              <input
                ...
                onChange={handleChange}
                className={`w-full rounded-lg border border-black form-control p-2 ${errors.state ? 'border-danger' : ''}`}
              />
              {errors.state && <span className="text-danger text-sm mt-1">{errors.state}</span>}
            </div>
            <div className="form-group">
              ...
              <input
                ...
                onChange={handleChange}
                className={`w-full rounded-lg border border-black form-control p-2 ${errors.zipCode ? 'border-danger' : ''}`}
              />
              {errors.zipCode && <span className="text-danger text-sm mt-1">{errors.zipCode}</span>}
            </div>
            <div className="form-group">
              ...
              <input
                ...
                onChange={handleChange}
                className={`w-full rounded-lg border border-black form-control p-2 ${errors.country ? 'border-danger' : ''}`}
              />
              {errors.country && <span className="text-danger text-sm mt-1">{errors.country}</span>}
            </div>
          </div>
